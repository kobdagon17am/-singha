                ...
                <div class="page-wrapper">				
                    <div class="page-body">
                        <div class="card tabs-card">					
                            ...
                            <h4>รายงานทะเบียนคุมใบจอง</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลรายงานทะเบียนคุมใบจอง</p>
                                <ul class="breadcrumb-title b-t-default p-t-10"></ul>					
                            </div>
                            
                            <!-- block -->
                            <div class="card-block">
                                <form class="form-horizontal" action="{{ route('pdf.report.audit_booking') }}" method="POST" target="_blank">
                                    {!! csrf_field() !!}
                                                        ...
                                                        <div class="form-group row"> 
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select class="form-control" name="market" id="market" required>
                                                                    <option value="1">เลือกตลาด</option>
                                                                    <option value="2">ตลาด 1</option>
                                                                    <option value="3">ตลาด 2</option>
                                                                </select>
                                                            </div> 
                                                        </div>
                                                        <div class="form-group row"> 
...
<script>
    $(document).ready(function(){
        var route_URL = "{{ route('backend.report.audit.booking') }}"; // URL 

                ...
                <div class="page-wrapper">				
                    <div class="page-body">
                        <div class="card tabs-card">					
                            ...
                            <h4>รายงานหลุดการจอง</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลรายงานหลุดการจอง</p>
                                <ul class="breadcrumb-title b-t-default p-t-10"></ul>					
                            </div>
                            
                            <!-- block -->
                            <div class="card-block">
                                <form class="form-horizontal" action="{{ route('pdf.report.cancel') }}" method="POST" target="_blank">
                                    {!! csrf_field() !!}
...
<script>
    $(document).ready(function(){
        var route_URL = "{{ route('backend.report.cancel') }}"; // URL 

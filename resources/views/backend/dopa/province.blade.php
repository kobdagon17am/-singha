                                    ...
                                    <table id="datatables" class="table  table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="">ชื่อจังหวัด</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="body_modal_add">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="name_th" id="name_th"   autocomplete="off" required>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal_edit" role="dialog">
        ...
        {!! csrf_field() !!}
            <div class="modal-dialog " id="reload_edit">
                <div class="modal-content">
                    <input type="hidden" id="id_province" name="id_province">
                    <div class="modal-header">
                     ...
                     <div class="modal-body" id="body_modal_edit">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right">ชื่อจังหวัด:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="name_th" id="name_e"   autocomplete="off"  >
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        $(".pcoded-submenu>li a[href='{{ url('backoffice/province') }}']").parent().addClass("active");
        $(".pcoded-submenu>li a[href='{{ url('backoffice/province') }}']").parent().parent().parent().addClass("pcoded-trigger");
    });
</script>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var oTable = $("#datatables").DataTable({
			...
			ajax:{
                url : "{{ route('api.province.datatable') }}",
                type: "POST",
				data: function (d) {
       ...
       function show(keep) {
            ...
            //  processData: false,
               success:function(data){
                ...
                $('#id_province').val(data.id);
                $('#name_e').val(data.name_th); // waitme hind

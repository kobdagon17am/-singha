                ...
                <div class="page-body">
                    <div class="card tabs-card">
                        ...
                        <div class="card-header">
                            <h4>ข้อมูลการจอง ลูกค้าประจำ / ลูกค้าทั่วไป</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลการจอง Booth ลูกค้าประจำ / ลูกค้าทั่วไป</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="text-right">
                                        ...
                                        <div class="form-group">
                                            <a href="#" class="btn btn-inverse btn-round " data-toggle="modal"
                                                data-target="#modal_upload"><i class="fa fa-plus"></i> อัพโหลดตารางการจองบูธประจำ</a>
                                        </div>
                                        <div class="form-group">
                                            <a href="#" class="btn btn-inverse btn-round " onclick="sentnotification_overdue()">
                            ...
                            <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" class="form-control form-control-normal" name="bd_booking_date"
                                        id="date_booking" autocomplete="off" required="" onchange="getDate()">
                                </div>
                            </div>
                            <div id="date_html">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="booking_id" name="booking_id">
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">ปิด</button>
                            <button type="button" class="btn btn-primary" onclick="importfile()">บันทึก</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        var oTable = $("#datatables").DataTable({
            ...
            ajax: {
                url: "{{ route('api.booking.datatable_regular') }}",
                type: "POST",
                data: function (d) {
...
<script>
    ...
    function importfile() {
        bootbox.confirm({
			title: "ยืนยัน ?",
			message: "ยืนยันการ importข้อมูลบูธประจำ ใช่หรือไม่?",
			buttons:{
				cancel: {

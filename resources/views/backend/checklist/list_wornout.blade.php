                ...
                <div class="page-wrapper">				
                    <div class="page-body">
                        <div class="card tabs-card">					
                            ...
                            <h4>รายการสินค้าชำรุด</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลรายการสินค้าชำรุด</p>
...
<script>
    $(document).ready(function(){
        var route_URL = "{{ route('backend.check.listwornout') }}"; // URL 
    ...
    $(document).ready(function(){
       //Datable
        var oTable = $("#datatables").DataTable({
            ...
            ajax:{ 
                url : "{{ route('api.listwornout.datatable') }}",
                data: function (d) {

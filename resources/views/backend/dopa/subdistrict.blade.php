                            ...
                            <div class="card-block">
                                ...
                                <div class="dt-responsive table-responsive">
                                    <table id="datatables" class="table  table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="text-center">ชื่อแขวง</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="body_modal_add">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label text-right">ชื่อ จังหวัด:</label>
                        <div class="col-sm-5">

                            <select name="province" id="province" class="form-control" onchange="selectdistrict(this.value ,1)" >
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label text-right">ชื่อ เขต:</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label text-right">ชื่อ แขวง:</label>
                        <div class="col-sm-5">
                    ...
                    <div class="modal-header">
                     ...
                     <div class="modal-body" id="body_modal_edit">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right">ชื่อ จังหวัด:</label>
                            <div class="col-sm-5">
                                <select name="province" id="province_e" class="form-control"  onchange="selectdistrict(this.value ,2)">
                                    @foreach ($province as $item)
                                    <option value="{{$item->id}}">{{$item->name_th}}</option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right">ชื่อ เขต:</label>
                            <div class="col-sm-5">
                                <select name="district" id="district_e" class="form-control" >
                                    @foreach ($district as $item)
                                    <option value="{{$item->id}}">{{$item->name_th}}</option>
                                    @endforeach
...
<script>
    $(document).ready(function(){
        $(".pcoded-submenu>li a[href='{{ url('backoffice/subdistrict') }}']").parent().addClass("active");
        $(".pcoded-submenu>li a[href='{{ url('backoffice/subdistrict') }}']").parent().parent().parent().addClass("pcoded-trigger");
    });
</script>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var oTable = $("#datatables").DataTable({
            ...
            ajax:{
                url : "{{ route('api.subdistrict.datatable') }}",
                type: "POST",
				data: function (d) {
            ...
            columns: [
                ...
                { 'className': "text-center", data: 'zip_code', name: 'zip_code' },
       ...
       function show(keep) {
            ...
            //  processData: false,
               success:function(data){
                ...
                $('#id_subdistrict').val(data.id);
                $('#province_e').val(data.province_id);
                $('#district_e').val(data.district_id);

                ...
                <div class="page-wrapper">				
                    <div class="page-body">
                        <div class="card tabs-card">					
                            ...
                            <h4>รายชื่อผู้ค้างจ่ายค่าปรับ</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลรายชื่อผู้ค้างจ่ายค่าปรับ</p>
...
<script>
    $(document).ready(function(){
        var route_URL = "{{ route('backend.check.listfine') }}"; // URL 
    ...
    $(document).ready(function(){
       //Datable
        var oTable = $("#datatables").DataTable({
            ...
            ajax:{ 
                url : "{{ route('api.listfine.datatable') }}",
                data: function (d) {

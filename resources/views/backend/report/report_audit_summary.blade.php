                ...
                <div class="page-wrapper">
                    <div class="page-body">
                        <div class="card tabs-card">
                            ...
                            <h4>รายงานสรุปยอดขาย</h4>
                            <p class="text-muted m-b-10">รายละเอียดข้อมูลรายงานสรุปยอดขาย</p>
                                <ul class="breadcrumb-title b-t-default p-t-10"></ul>
                            </div>

                            <!-- block -->
                            <div class="card-block">
                                <form class="form-horizontal" action="{{ route('pdf.report.audit_summary') }}" method="POST" target="_blank">
                                    {!! csrf_field() !!}
...
<script>
    $(document).ready(function(){
        var route_URL = "{{ route('backend.report.audit.summary') }}"; // URL
